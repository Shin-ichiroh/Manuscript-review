...
# Install Microsoft ODBC Driver for Azure SQL Database (and pyodbc build deps)
RUN apt-get update && apt-get install -y curl apt-transport-https unixodbc-dev gnupg2 \
