...
###SPLIT###
    - 待遇により差異があるとき
        ...
        ・**（重要）**: 試用期間においても、固定残業制を採用する場合は、本採用時と同様に必須3項目（1.固定残業代の金額、2.充当する労働時間数、3.超過分の追加支給）の記載が不可欠です。本採用時と試用期間で給与体系が異なる場合は、必ず両方の体系それぞれについて固定残業の必須3項目が明記されているか確認してください。
###SPLIT###
...
###SPLIT###
    - 給与欄の学歴・年齢と応募資格の整合性
        ・給与欄には学歴や年齢に応じた賃金が記載されています。ここでの記載と応募資格欄の記載に過不足や矛盾がないか確認してください。
        ・例えば、応募資格に大学院修了・大学卒と記載あるときに、給与欄に大学卒の給与しか表記されていなければ不整合として指摘をしてください。
###SPLIT###
        ・**（重要）**: 応募資格で「学歴不問」や「年齢不問（記載なし）」となっているにもかかわらず、給与欄で「大卒」や「22歳以上」など特定の高い条件に対する給与しか記載されていない場合、または「高卒以上」が資格なのに給与が「20代前半」の例しかないなど、**応募可能な最下限の条件に対する最低保証給与が不明瞭な場合は、不当な表記として指摘**してください。
###SPLIT###
        ・また、応募資格（求める人材）欄で特定の学歴の記載がない（＝学歴不問と理解できる）場合、給与欄には最も低い学歴（例：中卒や高卒）の最低限の金額を明示しなければなりません。「高卒の方は相談させていただきます」のように具体的な最低金額が明記されず曖昧になっている場合は、不整合として指摘をしてください。
...
###SPLIT###
    - 固定残業制を採用している場合は、固定残業代の金額、その時間に充当する労働時間数、固定残業代を超える労働を行った場合の追加支給の旨が記載されているか確認する。**本採用時と試用期間中の両方で給与額が異なる場合で、それぞれ固定残業代が含まれるときは、両方の給与体系に対してこの3項目が記載されている必要があります。片方でも不足していれば指摘してください。**
###SPLIT###
...
###SPLIT###
    - フレックスタイム制の場合、実働労働時間の表記がない、またはコアタイム（あるいはコアタイムなしの旨）の表記がない場合は指摘する。
###SPLIT###
    - 変形労働時間制の場合、「1年単位の変形労働時間制」や「1ヵ月単位の変形労働時間制」などの明記と、実働時間の表記がない場合は確認・指摘する。
###SPLIT###
...
###SPLIT###
    ...
    ## 大項目７：文書校正について
    - 求人原稿内「連絡先」「企業HP」などに、マイナビ・リクナビなどの競合他社リンクや他社サービスの案内が記載されていないか確認し、あれば削除するように指摘する。
###SPLIT###
    - 誤字脱字の有無を確認し、指摘する。
###SPLIT###
